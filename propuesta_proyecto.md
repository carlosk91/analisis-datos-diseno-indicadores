...
4.  **Transformación e integración de datos:**
    ...
    *   Crean los KPIs que consideren necesarios. 
...
1.  **Definición y cálculo de indicadores:**
    ...
    *   **Ejemplos:**
        ...
        *   **KPI 2:** Densidad de negocios *retail* por kilómetro cuadrado en un vecindario. 
        *   **KPI 3:** Cambio YoY de mediana de precios de casas en un vecindario. 
...
2.  **Regresión:**
    *   Construye modelos de regresión para medir factores que pueden influenciar a variables. Por ejemplo: 
        *   **Modelo 1:** Predice el valor de las propiedades basándote en la densidad de negocios, densidad poblacional y tasa de crimen. 
...
*   **Código:** Jupyter Notebook bien documentado.
*   **Presentación Ejecutiva**
    * A presentar al grupo
